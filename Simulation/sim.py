...
# Entry for the parameters
param1 = 1.2 # compliance direction (N/mm) 
param2 = 52.4 # assembly direction (N/mm)
param3 = 100 # depth direction (N/mm)
param4 = 100 #  z-rotation (paper), x- rotation (alex) (Nm/rad)
param5 = 100 #  y-rotation (paper), y- rotation (alex) (Nm/rad)
